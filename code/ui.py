...
class UI:
    ...
    def show_bar(self, current, max_amount, bg_rect, color):
        ...
        pygame.draw.rect(self.display_surface, color, current_rect, border_radius=10)
        pygame.draw.rect(self.display_surface, UI_BORDER_COLOR, bg_rect, 3, border_radius=10)
    ...
    def show_exp(self, exp):
        ...
        pygame.draw.rect(self.display_surface, EXPERIENCE_BACKGROUND, text_rectangle.inflate(10,10), border_radius=10)
        pygame.draw.rect(self.display_surface, UI_BORDER_COLOR, text_rectangle.inflate(10,10), 2, border_radius=10)
    ...
    def selection_box(self, left, top, has_switched):
        ...
        pygame.draw.rect(self.display_surface, UI_BG_COLOR, bg_rect, border_radius=10)
        if has_switched:
            pygame.draw.rect(self.display_surface, UI_BORDER_COLOR_ACTIVE, bg_rect, 3, border_radius=10)
        else:
            pygame.draw.rect(self.display_surface, UI_BORDER_COLOR, bg_rect, 3, border_radius=10)
        return bg_rect
